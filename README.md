...
[스크린샷](https://github.com/GunWooJung/READMEImage/blob/main/Screenshot_20250201_132317_YouTube.jpg)
...
ERD 설계 + 백엔드 모든 기능 구현 + CI/CD 및 클라우드 배포
...
- 기존에 댓글 목록 조회 시 **작성자 명**을 가져오는 과정에서 **N+1 문제**가 발생하였습니다.  
  ...
  - 개선 전: 댓글 목록을 조회할 때마다 작성자마다 쿼리 발생으로 성능 저하가 발생  
